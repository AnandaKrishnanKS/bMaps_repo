...
import { DataTablePagination } from "./BudgetTablePagination";
...
export function BudgetDataTable({ columns, data, setData }: any) {
  const { body, dispatchBody, loading } = React.useContext(BudgetContext);

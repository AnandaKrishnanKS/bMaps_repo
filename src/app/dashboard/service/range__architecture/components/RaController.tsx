...
import RaTabView from "./RaTabView";
import { messageBodyReducer } from "./reducer/messageBodyReducer";

export const RaContext = createContext<any>({});

export default function RaController() {
  ...
  const [activeTab, setActiveTab] = useState("raBudgetValue");

...
import SpTabView from "./SpTabView";
import { messageBodyReducer } from "./reducer/messageBodyReducer";

export const SpContext = createContext<any>({});

export default function SpController() {
  ...
  const [activeTab, setActiveTab] = useState("spBudgetValue");

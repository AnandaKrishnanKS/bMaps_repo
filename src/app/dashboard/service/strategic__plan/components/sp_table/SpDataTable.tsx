...
import { DataTablePagination } from "./SpTablePagination";
...
export function SpDataTable({ columns, data, setData }: any) {
  const { body, dispatchBody, loading } = React.useContext(SpContext);

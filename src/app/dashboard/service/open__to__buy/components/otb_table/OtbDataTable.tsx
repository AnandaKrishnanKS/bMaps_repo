...
import { DataTablePagination } from "./OtbTablePagination";
...
export function OtbDataTable({ columns, data, setData }: any) {
  const { body, dispatchBody, loading } = React.useContext(OtbContext);
